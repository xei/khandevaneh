...
public class MockApiRequest<T> {
    ...
    public MockApiRequest(int httpMethod, final String query, HashMap<String, String> params, Type responseType, String requestTag, final WebApiListener webApiListener, LoadRequests loadRequestsInterface) {
...
//        }
    ...
    public interface LoadRequests {
        void addRequestToLoadList(MockApiRequest<?> request, boolean loadDataOnResume);
