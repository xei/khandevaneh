package ir.tvnasim.khandevaneh.view;
...
import ir.tvnasim.khandevaneh.helper.typography.TypeFaceHelper;
 ...
 */
public class XeiTextView extends AppCompatTextView {
    ...
    public XeiTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public XeiTextView(Context context, AttributeSet attrs, int defStyleAttr) {
